  ...
  var Validator = (function () {
      ...
      proto.validate = function (value, additionalContext) {
        ...
        return new Promise(function(resolve, reject) {
          var a = self.valFn(value, currentContext);
          if(a['catch'] && a['then'] && a['finally']) {
            resolve(a);
          } else {
            resolve({valid: a, result: null});
          }
          //} catch (e) {
          ...
          if (res.valid) {
            ...
            return new ValidationError(self, currentContext, self.getMessage());
          }
        });
      };
...
// expose
  ...
  var EntityAspect = (function () {
      ...
      proto.validateEntity = function ( ) {
        if(this.entity._triggerValidation)
          return validateTarget(this);
      };

      function validateTarget(target, coIndex) {
        var ok = true;
        var promises = [];
        var stype = target.entity.entityType || target.entity.complexType;
        var aspect = target.entity.entityAspect || target.entity.complexAspect;
        var entityAspect = target.entity.entityAspect || target.entity.complexAspect.getEntityAspect();
        ...
        stype.getProperties().forEach(function (p) {
          ...
          if (validators.length > 0) {
            ...
            validators.forEach(function(validator) {
              var a = validate(target, validator, value, context);
              promises.push(a);
            });
          }
      ...
      proto.validateProperty = function (property, context) {
        ...
        return this._validateProperty(value, context).then(errors => errors.filter(error => error !== null));
      };
      ...
      proto._validateProperty = function (value, context) {
        ...
        var ok = true;
        var promises = [];
        //if(context.entity._triggerValidation) {
          context.property.getAllValidators().forEach(function (validator) {
            promises.push(validate(self, validator, value, context));
          });
          //context.entity._triggerValidation = false;
        //}
    ...
    proto.fetchMetadata = function (metadataStore, dataService) {
      ...
      OData.read({
        ...
        function (data) {
          ...
          // TODO tymczasowy hack
          csdlMetadata.schema.splice(1,1);
    ...
    function createChangeRequests(saveContext, saveBundle) {
      ...
      saveBundle.entities.forEach(function (entity, index) {
        ...
        if (aspect.entityState.isAdded()) {
          var defaultResourceName = entity.entityType.defaultResourceName
            ? entity.entityType.defaultResourceName
            : entity.entityType.baseEntityType.defaultResourceName + '/' + entity.entityType.baseEntityType.namespace + '.' + entity.entityType.shortName;
